...
export function SignOutButton() {
    ...
    return (
        <button
            ...
            onClick={handleClick}
            disabled={busy}
            className="px-3 py-1.5 font-mono text-sm border border-border rounded-md text-muted-foreground transition-colors duration-150 hover:border-primary hover:text-primary disabled:opacity-50"
        >
